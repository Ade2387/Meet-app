...
arno = User.new(username: "arno", email: "meetarno2022@gmail.com", password: "password", first_name: "Arno", last_name: "Debelle", company: "Meet")
...
oleg = User.new(username: "oleg", email: "olafdery@gmail.com", password: "password", first_name: "Oleg", last_name: "Deru", company: "Meet")
...
sebastien = User.new(username: "sebastien", email: "bas_neyt@hotmail.com", password: "password", first_name: "Sebastien", last_name: "Neyt", company: "Meet")
...
anis = User.new(username: "anis", email: "darzikolahi@gmail.com", password: "password", first_name: "Anis", last_name: "Samimi", company: "Meet")
